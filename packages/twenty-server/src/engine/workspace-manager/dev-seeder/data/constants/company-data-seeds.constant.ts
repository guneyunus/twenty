...
const REFERANSAL_COMPANY_DATA_SEEDS_RAW = [
  {
    id: COMPANY_DATA_SEED_IDS.ID_1,
    name: 'Referansal Platform',
    domainNamePrimaryLinkUrl: 'referansal.com',
    addressAddressCity: 'Istanbul',
    employees: 18,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/referansal',
    createdBySource: 'MANUAL',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_2,
    name: 'Mavi Bulut Yazilim',
    domainNamePrimaryLinkUrl: 'mavibulutyazilim.com',
    addressAddressCity: 'Istanbul',
    employees: 42,
    linkedinLinkPrimaryLinkUrl:
      'https://linkedin.com/company/mavi-bulut-yazilim',
    createdBySource: 'IMPORT',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.JONY,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_3,
    name: 'Ada Hukuk ve Danismanlik',
    domainNamePrimaryLinkUrl: 'adahukuk.com',
    addressAddressCity: 'Izmir',
    employees: 16,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/ada-hukuk',
    createdBySource: 'EMAIL',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.PHIL,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_4,
    name: 'Kuzey Mali Musavirlik',
    domainNamePrimaryLinkUrl: 'kuzeymali.com',
    addressAddressCity: 'Ankara',
    employees: 12,
    linkedinLinkPrimaryLinkUrl:
      'https://linkedin.com/company/kuzey-mali-musavirlik',
    createdBySource: 'WORKFLOW',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_5,
    name: 'Pusula Dijital Pazarlama',
    domainNamePrimaryLinkUrl: 'pusuladijital.com',
    addressAddressCity: 'Istanbul',
    employees: 27,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/pusula-dijital',
    createdBySource: 'CALENDAR',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_6,
    name: 'Vizyon Insaat Cozumleri',
    domainNamePrimaryLinkUrl: 'vizyoninsaat.com',
    addressAddressCity: 'Bursa',
    employees: 65,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/vizyon-insaat',
    createdBySource: 'MANUAL',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.PHIL,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_7,
    name: 'Nehir IK Danismanlik',
    domainNamePrimaryLinkUrl: 'nehirik.com',
    addressAddressCity: 'Antalya',
    employees: 22,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/nehir-ik',
    createdBySource: 'API',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.JONY,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_8,
    name: 'Nova Saglik Hizmetleri',
    domainNamePrimaryLinkUrl: 'novasaglik.com',
    addressAddressCity: 'Istanbul',
    employees: 38,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/nova-saglik',
    createdBySource: 'WEBHOOK',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_9,
    name: 'Akademi Plus Egitim',
    domainNamePrimaryLinkUrl: 'akademiplus.com',
    addressAddressCity: 'Eskisehir',
    employees: 19,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/akademi-plus',
    createdBySource: 'IMPORT',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.JANE,
  },
  {
    id: COMPANY_DATA_SEED_IDS.ID_10,
    name: 'Atlas Lojistik',
    domainNamePrimaryLinkUrl: 'atlaslojistik.com',
    addressAddressCity: 'Kocaeli',
    employees: 54,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/atlas-lojistik',
    createdBySource: 'EMAIL',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.PHIL,
  },
  {
    id: COMPANY_DATA_SEED_IDS.ID_11,
    name: 'Eksen Mimarlik',
    domainNamePrimaryLinkUrl: 'eksenmimarlik.com',
    addressAddressCity: 'Istanbul',
    employees: 31,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/eksen-mimarlik',
    createdBySource: 'MANUAL',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.JONY,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_12,
    name: 'Denge Finansal Planlama',
    domainNamePrimaryLinkUrl: 'dengefinans.com',
    addressAddressCity: 'Ankara',
    employees: 24,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/denge-finans',
    createdBySource: 'WORKFLOW',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_13,
    name: 'TEAM Bogazici Chapter',
    domainNamePrimaryLinkUrl: 'teambogazici.com',
    addressAddressCity: 'Istanbul',
    employees: 45,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/team-bogazici',
    createdBySource: 'MANUAL',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.PHIL,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_14,
    name: 'TEAM Ege Chapter',
    domainNamePrimaryLinkUrl: 'teamege.com',
    addressAddressCity: 'Izmir',
    employees: 36,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/team-ege',
    createdBySource: 'CALENDAR',
    createdByWorkspaceMemberId: WORKSPACE_MEMBER_DATA_SEED_IDS.TIM,
    createdByName: 'Tim A',
    accountOwnerId: WORKSPACE_MEMBER_DATA_SEED_IDS.JANE,
  ...
  {
    id: COMPANY_DATA_SEED_IDS.ID_15,
    name: 'Referansal Kurumsal Lead Havuzu',
    domainNamePrimaryLinkUrl: 'leads.referansal.com',
    addressAddressCity: 'Istanbul',
    employees: 1,
    linkedinLinkPrimaryLinkUrl: 'https://linkedin.com/company/referansal',
    createdBySource: 'API',
...
export const COMPANY_DATA_SEEDS: CompanyDataSeed[] = [
  ...REFERANSAL_COMPANY_DATA_SEEDS_RAW,
  ...COMPANY_DATA_SEEDS_RAW.slice(REFERANSAL_COMPANY_DATA_SEEDS_RAW.length),
].map((company, index) => ({
  ...company,
